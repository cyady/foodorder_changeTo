    ...
    <section style={{height: '200vh'}} id="home" className={classes.container}>
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <h2 className={classes.title}>Do you carve delicious food </h2>
          ...
          <p className={classes.desc}>
            Our restaurnt always puts the client above.
            They are our single most important thing or out business.
          </p>
